...
import 'menu_side_bar_com_atualizacao_model.dart';
export 'menu_side_bar_com_atualizacao_model.dart';

class MenuSideBarComAtualizacaoWidget extends StatefulWidget {
  const MenuSideBarComAtualizacaoWidget({super.key});

  @override
  State<MenuSideBarComAtualizacaoWidget> createState() =>
      _MenuSideBarComAtualizacaoWidgetState();
}

class _MenuSideBarComAtualizacaoWidgetState
    extends State<MenuSideBarComAtualizacaoWidget> {
  late MenuSideBarComAtualizacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuSideBarComAtualizacaoModel());
  }
